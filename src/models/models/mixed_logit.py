...
# import ghalton ==> unavailable for Python 3.9
from scipy.stats import qmc
from src.models.models import Model
from src.models.optimization.non_linear import Constraints
from src.models.utils import generate_n_equal_numbers_that_sum_one, generate_n_random_numbers_that_sum_one, ZERO_LOWER_BOUND
...
class MixedLogitModel(Model):
    ...
    def __init__(self, products, mus, sigmas):
        ...
        # self.random_numbers = ghalton.Halton(len(self.products)).get(self.NUMBER_SAMPLES)   # ==> unsupported
        self.random_numbers = qmc.Halton(d=len(self.products)).random(self.NUMBER_SAMPLES)
